...
<div class="<?php echo $this->plugin_name ?>_admin_lightbox <?php echo $this->plugin_name ?>_interface">
	<div class="<?php echo $this->plugin_name ?>_lightbox_title"></div>
	<a href="#" class="<?php echo $this->plugin_name ?>_close_lightbox">×</a>

	<div id="<?php echo $this->plugin_name ?>_lightbox_container">
		<div class="<?php echo $this->plugin_name ?>_lightbox_inner"></div>
	</div>
</div>
<div class="<?php echo $this->plugin_name ?>_overlay"></div>
