(function ($) {
    ...
    var PTB_CPT = library(function () {
        ...
        var createMetaBoxItems = function () {
            ...
            $.each(options, function (id, option) {
                createMetaBoxItem(id, option).show();
            });
    ...
    var PTB_PTT = library(function () {
        ...
        var bindLightboxActions = function () {
            ...
            $('.ptb_close_lightbox, .ptb_cancel_lightbox').click(function (e) {
                closeLightBox(e);
            });
        ...
        var openLightBox = function (e, title, content) {
            ...
            $('.ptb_lightbox_title').text(title);
            $('.ptb_lightbox_inner').html(content);
            $('.ptb_overlay,.ptb_admin_lightbox').show();
            $('.ptb_admin_lightbox').css('top', getDocHeight()).animate({
                top: 100
            }, 800);
        };
        ...
        var closeLightBox = function (e) {
            ...
            $('.ptb_admin_lightbox').animate({
                top: getDocHeight()
            }, 800, function () {
                // Animation complete.
                $('.ptb_lightbox_inner').empty();
                $('.ptb_lightbox_title').text('');
                $('.ptb_overlay,.ptb_admin_lightbox').hide();
