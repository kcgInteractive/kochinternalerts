...
class PTB_Form_CPT {
	...
	public function cmb_section_cb() {
		...
		foreach ( $cmb_types as $type => $args ) {
			...
			<li id="<?php print( $id ); ?>" data-template="<?php print( $type ); ?>"
				...
				<div class="ptb_cmb_item_body">
					...
					<?php
					// Action for all meta box types
					//do_action( 'ptb_cmb_template', $id );
		...
		//add_action('ptb_add_meta_box', function($get_name) {
		//error_log($get_name('test1'));
		//});

		//do_action('ptb_add_meta_box', array($this, 'get_input_name'));
