...
class PTB_Custom_Taxonomy {
	...
	public function get_args() {
		...
		$labels = array(
			'name'                       => isset($this->plural_label[ $lng ])?$this->plural_label[ $lng ]:'',
			'singular_name'              => isset($this->singular_label[ $lng ])?$this->singular_label[ $lng ]:'',
                    // Custom labels
			'search_items'               => isset($this->cl_search_items[ $lng ])?sprintf( $this->cl_search_items[ $lng ], $this->plural_label[ $lng ] ):__( 'Search Items', 'ptb' ),
			'popular_items'              => isset($this->cl_popular_items[ $lng ])?sprintf( $this->cl_popular_items[ $lng ], $this->plural_label[ $lng ] ):__( 'Popular Items', 'ptb' ),
			'all_items'                  => isset($this->cl_all_items[ $lng ])?sprintf( $this->cl_all_items[ $lng ], $this->plural_label[ $lng ] ):__( 'All Items', 'ptb' ),
			'parent_item'                => isset($this->cl_parent_item[ $lng ])?sprintf( $this->cl_parent_item[ $lng ], $this->singular_label[ $lng ] ):__( 'Parent Item', 'ptb') ,
			'parent_item_colon'          => isset($this->cl_parent_item_colon[ $lng ])?sprintf( $this->cl_parent_item_colon[ $lng ], $this->singular_label[ $lng ] ):__( 'Parent Item Colon', 'ptb' ),
			'edit_item'                  => isset($this->cl_edit_item[ $lng ])?sprintf( $this->cl_edit_item[ $lng ], $this->singular_label[ $lng ] ):__( 'Edit Item', 'ptb' ),
			'update_item'                => isset($this->cl_update_item[ $lng ])?sprintf( $this->cl_update_item[ $lng ], $this->singular_label[ $lng ] ):__( 'Update Item', 'ptb' ),
			'add_new_item'               => isset($this->cl_add_new_item[ $lng ])?sprintf( $this->cl_add_new_item[ $lng ], $this->singular_label[ $lng ] ): __( 'Add New Item', 'ptb' ),
			'new_item_name'              => isset($this->cl_new_item_name[ $lng ])?sprintf( $this->cl_new_item_name[ $lng ], $this->singular_label[ $lng ] ):'',
			'separate_items_with_commas' => isset($this->cl_separate_items_with_commas[ $lng ])?sprintf( $this->cl_separate_items_with_commas[ $lng ], strtolower( $this->plural_label[ $lng ] ) ):'',
			'add_or_remove_items'        => isset($this->cl_add_or_remove_items[ $lng ])?sprintf( $this->cl_add_or_remove_items[ $lng ], strtolower( $this->plural_label[ $lng ] ) ):__( 'Add or Remove Items', 'ptb' ),
			'choose_from_most_used'      => isset($this->cl_choose_from_most_used[ $lng ])?sprintf( $this->cl_choose_from_most_used[ $lng ], strtolower( $this->plural_label[ $lng ] ) ):'',
			'menu_name'                  => isset($this->cl_menu_name[ $lng ])?sprintf( $this->cl_menu_name[ $lng ], $this->singular_label[ $lng ] ):'',
		);
