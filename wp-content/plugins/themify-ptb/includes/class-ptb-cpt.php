...
class PTB_Custom_Post_Type {
	...
	public function get_args() {
		...
		$labels = array(
			...
			'menu_name'          => isset( $this->cl_menu_name[ $lng ])?sprintf( $this->cl_menu_name[ $lng ], $this->plural_label[ $lng ] ):'',
			'name_admin_bar'     => isset($this->singular_label[ $lng ])?$this->singular_label[ $lng ]:'',
			'add_new'            => isset($this->cl_add_new[ $lng ])?$this->cl_add_new[ $lng ]:__( 'Add New', 'ptb' ),
			'add_new_item'       => isset( $this->cl_add_new_item[ $lng ])?sprintf( $this->cl_add_new_item[ $lng ], $this->singular_label[ $lng ] ):__( 'Add New Item', 'ptb' ),
			'new_item'           => isset( $this->cl_new_item[ $lng ])?sprintf( $this->cl_new_item[ $lng ], $this->singular_label[ $lng ] ):__( 'New Item', 'ptb' ),
			'edit_item'          => isset($this->cl_edit_item[ $lng ])?sprintf( $this->cl_edit_item[ $lng ], $this->singular_label[ $lng ] ):__( 'Edit Item', 'ptb' ),
			'view_item'          => isset( $this->cl_view_item[ $lng ])?sprintf( $this->cl_view_item[ $lng ], $this->singular_label[ $lng ] ):__( 'View Item', 'ptb' ),
			...
			'parent_item_colon'  => isset($this->cl_parent_item_colon[ $lng ])?sprintf( $this->cl_parent_item_colon[ $lng ], $this->plural_label[ $lng ] ):__( 'Parent Item Colon', 'ptb' ),
			'not_found'          => isset($this->cl_not_found[ $lng ])?$this->cl_not_found[ $lng ]:__( 'Not Found', 'ptb' ),
			'not_found_in_trash' => isset($this->cl_not_found_in_trash[ $lng ])?$this->cl_not_found_in_trash[ $lng ]:__( 'Not Found In Trash','ptb' )
		);
