	...
	public function ptt_post_type_cb() {
		...
		if ( $post_types ) {
			...
			foreach ( $post_types as $post_type ) {
				...
				$name    = $post_type->slug;
				$label   = isset($post_type->singular_label[$lang])?$post_type->singular_label[$lang]:'';
			...
			<div class="ptb_ptt_edit_buttons_wrapper">
				...
				<div>
					<a href="#" title="<?php _e( 'Single Post Template', 'ptb' ); ?>"
					   data-template-type="single" id="ptb_ptt_edit_single" class="ptb_ptt_edit_button ptb_lightbox">
