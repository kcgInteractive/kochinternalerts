...
function themify_portfolio_post_setup() {
	...
	if( ! defined( 'THEMIFY_PORTFOLIO_POST_DIR' ) )
		...
		define( 'THEMIFY_PORTFOLIO_POST_DIR', trailingslashit( plugin_dir_path( __FILE__ ) ) );



	if( ! defined( 'THEMIFY_PORTFOLIO_POST_URI' ) )

		define( 'THEMIFY_PORTFOLIO_POST_URI', trailingslashit( plugin_dir_url( __FILE__ ) ) );



	if( ! defined( 'THEMIFY_PORTFOLIO_POST_VERSION' ) )

		define( 'THEMIFY_PORTFOLIO_POST_VERSION', '1.0.1' );
