...
class Themify_Portfolio_Post {
	...
	public function actions() {
		...
		add_action( 'themify_builder_setup_modules', array( $this, 'register_builder_module' ) );
	...
	public function register_builder_module( $ThemifyBuilder ) {

		$ThemifyBuilder->register_directory( 'templates', $this->dir . 'includes/themify-builder/templates' );

		$ThemifyBuilder->register_directory( 'modules', $this->dir . 'includes/themify-builder/modules' );
