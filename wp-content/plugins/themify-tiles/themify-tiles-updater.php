...
class Themify_Tiles_Updater {
	...
	public function enqueue() {
		...
		wp_localize_script( 'themify-builder-plugin-upgrade', 'themify_lang', array(
			...
			'invalid_login' => __('Invalid username or password.<br/>Contact <a href="http://themify.me/contact">Themify</a> for login issues.', 'themify-tiles'),
			'unsuscribed' => __('Your membership might be expired. Login to <a href="http://themify.me/member">Themify</a> to check.', 'themify-tiles'),
		));
